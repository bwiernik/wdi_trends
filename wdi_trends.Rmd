...
For efficiency, you could skip the data downloading and use a precompiled dataset:

- [<i class="fas fa-file-csv"></i> `wdi_co2.csv`](https://datavizm20.classes.andrewheiss.com/data/wdi_co2.csv)


## Did Countries' Relative CO<sub>2</sub> Emissions Performance Change Over Time?

From the 1990s through the 2010s, increasing global and political attention was paid to reducing carbon emissions to combat climate change. During this time, did some countries do substantially better and reduce their emissions more than their peers?

To answer this question, we will use a dataset compiled from the World Bank's World Development Indicators.
...
Overall, based on these data, there appears to be substantial stability in relative CO<sub>2</sub> emissions across countries between 1995 and 2014. Despite this strong overall trend, there were some countries, such as Moldova, that substantially improved their relative emissions. Other countries, particularly those that were rapidly industrializing, demonstrated large relative declines in their emissions performance. 
